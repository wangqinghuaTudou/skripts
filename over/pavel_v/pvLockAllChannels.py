...
/*! ## Скрипт лочит каналы объектов в сцене по их суффиксам.

> 1. Если выбран параметр "all" то скрипт проходит по сцене и лочит все объекты с правильными суффиксами.
> 2. Если выбран суффикс, то скрипт лочит каналы только для объектов с заданным суффиксом.
> 3. Если выбран режим "selected", то скрипт лочит все каналы у выделенного объекта, независимо от его суффикса.
> 4. Тоже самое для разлочивания каналов.
*/
...
global proc pvLockChannelsMain ()
{
    ...
    print ($count + " items was successfully locked. \n") ;
}
